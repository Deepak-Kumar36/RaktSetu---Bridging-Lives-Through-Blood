...
function DonorProfileCard({ profile, onUpdate, onToggleAvailability, updating, isEligibleNow, nextEligibleDate }) {
    ...
    const isAvailable = profile.isAvailable === 'Yes';
    const blockedByCooldown = !isAvailable && !isEligibleNow;
                ...
                <>
                    <div className="row g-2 mb-3" style={{ fontSize: '0.9rem' }}>
                        ...
                        <div className="col-12">
                            ...
                            {profile.lastDonationDate || 'No donations yet'}
                        </div>
                    </div>
                        ...
                        <div>
                            <div className="form-check form-switch">
                                <input
                                    ...
                                    role="switch"
                                    checked={isAvailable}
                                    disabled={updating || blockedByCooldown}
                                    onChange={(e) => onToggleAvailability(e.target.checked ? 'Yes' : 'No')}
                                />
                            ...
                            {blockedByCooldown && (
                                <div className="text-muted mt-1" style={{ fontSize: '0.75rem' }}>
                                    In cooldown until {nextEligibleDate?.toLocaleDateString()}
                                </div>
                            )}
                        </div>
                ...
                <form onSubmit={handleSave}>
                    <div className="row">
                        ...
                        <div className="col-md-6 mb-3">
                            ...
                            <input type="number" name="age" className="form-control" value={form.age} onChange={handleChange} min={18} />
                        </div>
                    </div>
                    <div className="row">
                        <div className="col-md-6 mb-3">
